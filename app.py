...
def index():
    ...
    stats = {
        'most_categories' : top_category[top_category['Jumlah'] == top_category['Jumlah'].max()]['Category'],
    ...
    'Content Rating': 'count'}).rename({'Content Rating':'Total'},axis =1).sort_values(by='Total',ascending=False).head(5)
    X = ContentRating_order.index
